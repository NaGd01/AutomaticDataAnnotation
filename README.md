...
The following open data sets matching the [GAIA-X ecosystem domains](https://gaia-x-hub.de/domaenen/) were used for the evaluation by competency questions as input to populate our knowledge graph, which was then queried using cypher queries and can further be used for testing purposes.
